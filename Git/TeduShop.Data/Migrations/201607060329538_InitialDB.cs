    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.PosttCategories", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "CategoryID", "dbo.PosttCategories");
